...
export function ThemedButtonWithIcon(props) {
    ...
    return (_jsx(ThemedButton, { theme: theme, variant: "secondary", onPress: onPress, children: _jsxs(View, { style: {
                flexDirection: "row",
                gap: spacing.md,
                paddingLeft: spacing.sm,
                alignContent: "center",
                width: "100%",
            }, children: [_jsx(RNImage, { theme: theme, size: 24, data: icon }), _jsx(ThemedText, { theme: theme, children: title })] }) }));
}
