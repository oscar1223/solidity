...
function ExecutingTxScreen(props) {
    ...
    return (_jsxs(Container, { p: "lg", children: [_jsx(ModalHeader, { title: "Transaction" }), _jsx(Spacer, { y: "xxl" }), _jsx(Spacer, { y: "xxl" }), _jsxs(Container, { flex: "row", center: "x", children: [status === "loading" && _jsx(Spinner, { size: "3xl", color: "accentText" }), "status === \"failed\" && ", _jsx(AccentFailIcon, { size: iconSize["3xl"] }), "status === \"sent\" && (", _jsx(Container, { color: "success", flex: "row", center: "both", children: _jsx(CheckCircledIcon, { width: iconSize["3xl"], height: iconSize["3xl"] }) }), ")"] }), _jsx(Spacer, { y: "lg" }), _jsx(Text, { color: "primaryText", center: true, size: "lg", children: "status === \"loading\" && \"Sending transaction\"status === \"failed\" && \"Transaction failed\"status === \"sent\" && \"Transaction sent\"" }), _jsx(Spacer, { y: "xxl" }), _jsx(Spacer, { y: "xxl" }), "status === \"failed\" && (", _jsx(Button, { variant: "accent", fullWidth: true, onClick: sendTx, children: "Try Again" }), ")status === \"sent\" && (", _jsx(Button, { variant: "accent", fullWidth: true, onClick: props.closeModal, children: "Done" }), ")"] }));
}
