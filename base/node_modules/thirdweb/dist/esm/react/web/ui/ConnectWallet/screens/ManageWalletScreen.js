...
export function ManageWalletScreen(props) {
    ...
    return (_jsxs(Container, { style: {
            minHeight: "300px",
        }, children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: "Manage Wallet", onBack: props.onBack }) }), _jsx(Line, {}), _jsxs(Container, { px: "sm", scrollY: true, style: {
                    maxHeight: "500px",
                                ...
                                }, children: [_jsx(WalletConnectIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: "Connect an App" })] }), activeWallet &&
                                ((isInAppWallet(activeWallet) &&
                                    ...
                                    fontSize: fontSize.sm,
                                }, children: [_jsx(KeyIcon, { size: iconSize.md }), _jsx(Text, { color: "primaryText", children: "Export Private Key" })] }))] }), _jsx(Spacer, { y: "lg" })] })] }));
}
