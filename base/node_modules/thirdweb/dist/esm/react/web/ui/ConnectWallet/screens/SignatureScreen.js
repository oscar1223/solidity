...
function HeadlessSignIn({ signIn, status, connectLocale, wallet, }) {
    ...
    return (_jsxs(Container, { p: "lg", fullHeight: true, flex: "column", animate: "fadein", children: [_jsx(ModalHeader, { title: locale.signingScreen.title }), _jsxs(Container, { expand: true, flex: "row", center: "both", style: {
                    minHeight: "250px",
                }, children: [status === "signing" && _jsx(Spinner, { size: "xl", color: "accentText" }), status === "failed" && (_jsx(_Fragment, { children: _jsxs(Container, { children: [_jsx(Spacer, { y: "lg" }), _jsx(Text, { size: "lg", center: true, color: "danger", children: locale.signingScreen.failedToSignIn }), _jsx(Spacer, { y: "lg" }), _jsxs(Button, { fullWidth: true, variant: "accent", onClick: () => {
                                        signIn();
                                    }, style: {
                                        gap: spacing.xs,
                                        alignItems: "center",
