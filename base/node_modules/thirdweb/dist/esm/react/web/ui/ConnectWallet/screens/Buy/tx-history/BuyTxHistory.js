...
export function BuyTxHistory(props) {
    ...
    if (selectedTx) {
        return (_jsx(TxDetailsScreen, { client: props.client, statusInfo: selectedTx, onBack: () => setSelectedTx(null), onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed }));
    }
    return _jsx(BuyTxHistoryList, { ...props, onSelectTx: setSelectedTx });
}
/**
 * @internal
 */
export function BuyTxHistoryList(props) {
    ...
    return (_jsxs(Container, { animate: "fadein", children: [_jsx(Container, { p: "lg", children: _jsx(ModalHeader, { title: "Transactions", onBack: props.onBack }) }), _jsxs(Container, { scrollY: true, flex: "column", fullHeight: true, style: {
                    minHeight: "250px",
                    maxHeight: "370px",
                }, children: [_jsxs(Container, { flex: "column", gap: "xs", px: "lg", expand: true, children: [noTransactions && !isLoading && (_jsxs(Container, { flex: "column", gap: "md", center: "both", color: "secondaryText", style: {
                                    minHeight: "250px",
                            ...
                            }), isLoading && txInfosToShow.length > 0 && (_jsxs(_Fragment, { children: [_jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), _jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight }), _jsx(Skeleton, { width: "100%", height: BuyTxHistoryButtonHeight })] }))] }), _jsx(Container, { p: "lg", children: pagination && !hidePagination && (_jsxs("div", { style: {
                                display: "grid",
                                ...
                                gap: spacing.sm,
                                        ...
                                        setPageIndex((prev) => prev + 1);
                                    }, children: ["Next", _jsx(ArrowRightIcon, { width: iconSize.sm, height: iconSize.sm })] })] })) })] }), _jsx(Line, {}), _jsx(Container, { p: "lg", children: _jsxs(ButtonLink, { fullWidth: true, variant: "outline", href: `${chainExplorers.explorers[0]?.url}/address/${activeAccount?.address}`, target: "_blank", as: "a", gap: "xs", style: {
                        textDecoration: "none",
                        color: "inherit",
