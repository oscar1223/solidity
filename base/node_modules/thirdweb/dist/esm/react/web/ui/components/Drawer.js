...
export const Drawer = /* @__PURE__ */ forwardRef(function Drawer_(props, ref) {
    return (_jsx(_Fragment, { children: _jsxs(DrawerContainer, { ref: ref, children: [_jsx(CrossContainer, { children: _jsx(IconButton, { type: "button", "aria-label": "Close", onClick: props.close, children: _jsx(Cross2Icon, { width: iconSize.md, height: iconSize.md, style: {
                                color: "inherit",
                            } }) }) }), props.children] }) }));
});
