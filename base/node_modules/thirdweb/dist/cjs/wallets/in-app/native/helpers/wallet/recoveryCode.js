...
exports.getCognitoRecoveryPassword = getCognitoRecoveryPassword;
...
async function getCognitoRecoveryPassword(client) {
    const idTokenResponse = await (0, fetchers_js_1.authFetchEmbeddedWalletUser)(client, constants_js_1.ROUTE_AUTH_COGNITO_ID_TOKEN, {
        method: "GET",
    });
    ...
    const functionName = constants_js_1.GENERATE_RECOVERY_PASSWORD_LAMBDA_FUNCTION;
    const params = {
