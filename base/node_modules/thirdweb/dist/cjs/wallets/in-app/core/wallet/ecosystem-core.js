...
function createEcosystemWallet(args) {
    ...
    return {
        ...
        autoConnect: async (options) => {
            ...
            const connector = await (0, in_app_core_js_1.getOrCreateInAppWalletConnector)(options.client, connectorFactory, {
                id,
        ...
        disconnect: async () => {
            ...
            if (client) {
                const connector = await (0, in_app_core_js_1.getOrCreateInAppWalletConnector)(client, connectorFactory, {
                    id,
                    partnerId: createOptions?.partnerId,
                });
