...
function ExternalWalletRow(props) {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_native_1.TouchableOpacity, { style: styles.row, onPress: () => connectWallet(wallet), children: [imageQuery.data ? (isConnecting ? ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    width: 52,
                    height: 52,
                    justifyContent: "center",
                    alignItems: "center",
                }, children: (0, jsx_runtime_1.jsx)(spinner_js_1.ThemedSpinner, { color: theme.colors.primaryText }) })) : ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: { uri: imageQuery.data ?? "" }, style: { width: 52, height: 52, borderRadius: 6 } }))) : ((0, jsx_runtime_1.jsx)(Skeleton_js_1.Skeleton, { theme: theme, style: {
                    width: 52,
                    height: 52,
