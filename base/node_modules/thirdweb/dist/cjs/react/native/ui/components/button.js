...
function ThemedButtonWithIcon(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(ThemedButton, { theme: theme, variant: "secondary", onPress: onPress, children: (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                flexDirection: "row",
                gap: index_js_1.spacing.md,
                paddingLeft: index_js_1.spacing.sm,
                alignContent: "center",
                width: "100%",
            }, children: [(0, jsx_runtime_1.jsx)(RNImage_js_1.RNImage, { theme: theme, size: 24, data: icon }), (0, jsx_runtime_1.jsx)(text_js_1.ThemedText, { theme: theme, children: title })] }) }));
}
