...
const BuyTxHistory_js_1 = require("../../ui/ConnectWallet/screens/Buy/tx-history/BuyTxHistory.js");
...
function useSendTransaction(config = {}) {
    ...
    return (0, useSendTransaction_js_1.useSendTransactionCore)({
        showPayModal: !payModalEnabled || payModal === false
            ? undefined
            : (data) => {
                setRootEl((0, jsx_runtime_1.jsx)(TxModal, { tx: data.tx, onComplete: data.sendTx, onClose: () => {
                        setRootEl(null);
                        data.rejectTx();
...
function ModalContent(props) {
    ...
    if (screen === "execute-tx") {
        return (0, jsx_runtime_1.jsx)(ExecutingTxScreen, { tx: props.tx, closeModal: props.onClose });
    }
    if (screen === "tx-history") {
        return ((0, jsx_runtime_1.jsx)(BuyTxHistory_js_1.BuyTxHistory, { client: props.client, onBack: () => {
                setScreen("buy");
            }, onDone: () => {
                setScreen("execute-tx");
            }, isBuyForTx: true, isEmbed: false }));
    }
    return ((0, jsx_runtime_1.jsx)(LazyBuyScreen_js_1.LazyBuyScreen, { isEmbed: false, client: props.client, onViewPendingTx: () => {
