...
function SwapFees(props) {
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "xs", style: {
            ...
            const feeAmount = (0, formatNumber_js_1.formatNumber)(Number(fee.amount), 4);
...
function FiatFees(props) {
    return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "xs", children: [(0, jsx_runtime_1.jsxs)("div", { style: {
                ...
                return ((0, jsx_runtime_1.jsxs)("div", { style: {
                    ...
                    display: "flex",
                    justifyContent: "space-between",
                }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { inline: true, color: "secondaryText", children: "Total" }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "primaryText", inline: true, children: [(0, formatNumber_js_1.formatNumber)(Number(props.quote.fromCurrencyWithFees.amount), 4), " ", props.quote.fromCurrencyWithFees.currencySymbol] })] })] }));
}
