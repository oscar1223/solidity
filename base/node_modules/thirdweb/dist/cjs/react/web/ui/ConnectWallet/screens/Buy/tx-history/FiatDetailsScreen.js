...
function FiatDetailsScreen(props) {
    ...
    if (hasTwoSteps) {
        ...
        return ((0, jsx_runtime_1.jsx)(PostOnRampSwapFlow_js_1.PostOnRampSwapFlow, { client: props.client, status: status, onBack: props.onBack, onViewPendingTx: props.onBack, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed, quote: {
