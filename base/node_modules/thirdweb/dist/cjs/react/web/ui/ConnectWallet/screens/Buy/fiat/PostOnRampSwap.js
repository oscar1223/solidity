...
function PostOnRampSwap(props) {
    ...
    if (postOnRampQuoteQuery.isError) {
        return ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { fullHeight: true, children: [(0, jsx_runtime_1.jsx)(basic_js_1.Container, { p: "lg", children: (0, jsx_runtime_1.jsx)(basic_js_1.ModalHeader, { title: "Buy", onBack: props.onBack }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { style: {
                        minHeight: "300px",
    ...
    return ((0, jsx_runtime_1.jsx)(SwapFlow_js_1.SwapFlow, { account: account, buyWithCryptoQuote: lockedOnRampQuote, client: props.client, onBack: props.onBack, onViewPendingTx: props.onViewPendingTx, isFiatFlow: true, onDone: props.onDone, onTryAgain: () => {
