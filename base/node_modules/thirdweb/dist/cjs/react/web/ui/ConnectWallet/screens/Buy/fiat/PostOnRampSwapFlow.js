...
function PostOnRampSwapFlow(props) {
    ...
    // step 2 flow
    if (statusForSwap) {
        return ((0, jsx_runtime_1.jsx)(PostOnRampSwap_js_1.PostOnRampSwap, { buyWithFiatStatus: statusForSwap, client: props.client, onViewPendingTx: props.onViewPendingTx, onDone: props.onDone, isBuyForTx: props.isBuyForTx, isEmbed: props.isEmbed }));
    }
    // show step 1 and step 2 details
    return ((0, jsx_runtime_1.jsx)(FiatSteps_js_1.FiatSteps, { client: props.client, onBack: props.onBack, partialQuote: props.quote, step: 2, onContinue: () => {
