...
const getInstalledExtensions_js_1 = require("../../extensions/modular/__generated__/ModularCore/read/getInstalledExtensions.js");
...
async function resolveModularExtensionAddresses(contract) {
    try {
        const extensions = await (0, getInstalledExtensions_js_1.getInstalledExtensions)({ contract });
        // if there are no plugins, return the root ABI
